...
public class AccountService {
    ...
    public String createAccount(String accountNumber, Double amount) throws ResponseStatusException {
        logger.debug("To create a cheque account: " + accountNumber + " with initial amount " + amount);
        ...
        ChequeAccount account = new ChequeAccount(accountNumber, amount);
        ChequeAccountTransaction accountTransaction = new ChequeAccountTransaction(accountNumber,
                amount, "create", new Date());
        accountRepository.save(account);
        transactionRepository.save(accountTransaction);
        return "Cheque Account " + accountNumber + " Created with amount: " + amount;
    }
    ...
    public synchronized String depositAccount(String accountNumber, Double amount) throws BankingException,
        ...
        List<ChequeAccount> accounts = accountRepository.getAccount(accountNumber);
        ...
        int updateCount = 0;
        for(ChequeAccount account : accounts) {
